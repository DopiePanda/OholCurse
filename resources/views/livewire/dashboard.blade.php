...
<div class="w-full lg:max-w-2/3">
    ...
    <div class="w-1/2 mx-auto flex flex-row gap-4 items-center justify-center">
        <div wire:click="setTab('contacts')" class="px-4 py-2 border border-skin-base dark:border-skin-base-dark rounded-lg cursor-pointer @if($tab == 'contacts') bg-skin-fill text-white @else text-skin-base dark:text-skin-base-dark @endif">
            Contacts
        </div>
        <div wire:click="setTab('interactions')" class="px-4 py-2 border border-skin-base dark:border-skin-base-dark rounded-lg cursor-pointer @if($tab == 'interactions') bg-skin-fill text-white @else text-skin-base dark:text-skin-base-dark @endif">
            Interactions
        </div>
        <div wire:click="setTab('reports')" class="px-4 py-2 border border-skin-base dark:border-skin-base-dark rounded-lg cursor-pointer @if($tab == 'reports') bg-skin-fill text-white @else text-skin-base dark:text-skin-base-dark @endif">
            Reports
        </div>
    </div>

    <div class="mt-4 w-full lg:w-8/12 xl:w-6/12 mx-auto">
        ...
        @elseif($tab == 'reports')
            ...
            <div class="w-full mx-auto py-4 px-6 mt-4 bg-skin-fill-wrapper dark:bg-skin-fill-wrapper-dark border rounded-xl border-skin-base dark:border-skin-base-dark">
                <div class="text-center mx-auto text-4xl mb-2 text-skin-base dark:text-skin-base-dark">
                    Curse reports
                </div>
                <div class="text-md text-center text-skin-muted dark:text-skin-muted-dark">
                    Upload your "yumlog.txt"-file to register the curse names of the players you have cursed
                </div>
                <div class="w-1/3 my-4 mx-auto border-b border-gray-300 dark:border-gray-600"></div>
                
                <div class="flex flex-row justify-center gap-4">
                    <div class="mx-2 px-4 py-2 cursor-pointer text-skin-base dark:text-skin-base-dark border border-skin-base dark:border-skin-base-dark rounded-md hover:bg-skin-fill dark:hover:bg-skin-fill-dark hover:text-white dark:hover:text-white" onclick="Livewire.dispatch('openModal', { component: 'modals.upload-logfile' })">
                        Upload Yumlog
                    </div>
                    <div class="mx-2 px-4 py-2 bg-skin-fill-muted dark:bg-skin-fill-muted-dark text-skin-inverted dark:text-skin-inverted-dark rounded-md cursor-pointer" wire:click="verifyCurses()">
                        Verify curses
                    </div>
                </div>

                <div class="relative overflow-x-auto">
                    <table class="mt-4 w-full mt-4 p-2 mx-auto border-spacing-2">
                        <thead>
                            <tr class="text-left">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="py-4 text-center bg-gray-300 dark:bg-slate-800 dark:text-gray-300">
                                        <div class="w-full text-center text-gray-800 dark:text-gray-300">
                                            No yumlogs uploaded
                                        </div>
                                        <div class="inline-block mt-2 px-4 py-2 cursor-pointer border border-skin-base dark:border-skin-base-dark rounded-md hover:bg-skin-fill dark:hover:bg-skin-fill-dark hover:text-white" onclick="Livewire.dispatch('openModal', { component: 'modals.upload-logfile' })">
                                            Upload Yumlog
                                        </div>
                                    </td>
                                </tr>
