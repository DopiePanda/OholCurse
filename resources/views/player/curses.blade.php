<x-app-layout>
    ...
    <div class="grow max-w-5xl flex flex-col">
        ...
        <div class="w-full mt-6 bg-gray-200 p-2 lg:p-6">
            <div class="p-4 mb-4 text-center">
                <!-- <div class="text-4xl">
                    ...
                    <div class="grid grid-cols-2 gap-4">      
                        <div class="p-2 bg-white border border-green-400 rounded-xl">
                        ...
                        <div class="p-2 bg-white border border-red-400 rounded-xl">
            ...
            <!-- Curses sent -->
            <div class="p-2 pt-2">
                <section class="accordion border border-blue-400">
                    ...
                    <div class="content ">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-2">
                            @forelse($sent['curses'] as $line)   
                                <div class="bg-white border border-blue-400 mt-1 p-2 rounded-lg">
                                    <div>
                                        ...
                                        <a href="{{ route('player.curses', ['hash' => $line['reciever_hash'] ?? 'error']) }}" title="{{ $line['reciever_hash'] }}"> 
                                            @if(isset($line['reciever_hash']))
                                                <div class="break-all text-blue-600 font-bold">{{ $line['contact_name'] ?? $line['leaderboard'] }} 
