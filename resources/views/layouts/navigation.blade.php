    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                <!-- <button class="p-2 border bg-red-400 text-white rounded-lg text-sm" onclick="Livewire.emit('openModal', 'modals.submit-report')">
                    Report Griefer
                </button> -->
                ...
                @endauth
                @guest
                    <button class="p-2 border border-blue-400 text-blue-400 rounded-lg" onclick="Livewire.emit('openModal', 'modals.authorize-modal')">Authorize</button>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                @guest
                    <button class="p-2 border border-blue-400 text-blue-400 rounded-lg" onclick="Livewire.emit('openModal', 'modals.authorize-modal')">Auth</button>
                @endguest
                @auth
                    <!-- <button class="p-2 border bg-red-400 text-white rounded-lg text-sm" onclick="Livewire.emit('openModal', 'modals.submit-report')">
                        Report Griefer
